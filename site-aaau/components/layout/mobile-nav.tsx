  ...
  return (
    <div className="lg:hidden">
      ...
      <button
        ...
        className={cn(
          "fixed inset-0 z-[80] bg-black/75 backdrop-blur-md transition-opacity duration-300",
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-[81] flex h-dvh min-h-screen w-full flex-col overflow-y-auto border-l border-white/10 bg-[#111111] px-5 py-6 shadow-[-24px_0_80px_rgba(0,0,0,0.45)] transition-transform duration-300 sm:w-[88vw] sm:max-w-sm sm:px-6",
